...
| W0-FINAL | `tracer-w0-final-integration` | `integration/tracer-w0-final` → `main` | See §12 | This report |
...
**Document control:** Final Gate 0 artifact. Update §16 SHAs only when main is fast-forwarded and lease released.
